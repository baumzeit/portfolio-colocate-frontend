  ...
  <div className="relative group">
    <Link to={`${PATH.PROJECTS}?area=${slug}`}>
      <div className="relative z-10">
        <div style={{ justifyContent: flex[alignment] }} className="flex items-center gap-1 mb-2.5">
    ...
    <div className={`absolute w-full flex ${blobOffset[alignment]}`} style={{ justifyContent: flex[alignment] }}>
      <div className="w-[340px] md:w-[430px] lg:w-[520px] opacity-30 transition-transform -mx-14 -my-14">
        <SvgBlob
          variant="solid"
          // colors={[areaColor || '', 'var(--color-brand)']}
          color={areaColor || ''}
          isOutline
